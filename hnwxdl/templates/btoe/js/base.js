...
function copyText(txt){
	...
	$.dialog.tips("复制成功，可以通过粘贴来发送！",2,"32X32/succ.png"/*tpa=http://www.hnwxdl.com/templates/btoe/js/32X32/succ.png*/);
} 
//全选取消按钮函数，调用样式如：
	...
	var m = $.dialog.confirm("删除记录后不可恢复，您确定吗？", function () {
		$.ajax({
			...
			success: function(data, textStatus) {
				if (data.status == 1){
					$.dialog.tips(data.msg, 2, "32X32/succ.png"/*tpa=http://www.hnwxdl.com/templates/btoe/js/32X32/succ.png*/, function(){
						if(urlObj){
